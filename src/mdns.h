...
typedef int (*mdns_record_callback_fn)(mdns_sock_t sock, const struct sockaddr* from, size_t addrlen,
...
//! and queries, you must set MDNS_PORT as port.
static inline int
mdns_socket_setup_ipv4(mdns_sock_t sock, const struct sockaddr_in* saddr);
...
//! and queries, you must set MDNS_PORT as port.
static inline int
mdns_socket_setup_ipv6(mdns_sock_t sock, const struct sockaddr_in6* saddr);

//! Close a socket opened with mdns_socket_open_ipv4 and mdns_socket_open_ipv6.
static inline void
mdns_socket_close(mdns_sock_t sock);
...
mdns_socket_listen(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_callback_fn callback,
                   void* user_data);

//! Send a multicast DNS-SD reqeuest on the given socket to discover available services. Returns 0
//! on success, or <0 if error.
static inline int
mdns_discovery_send(mdns_sock_t sock);
...
static inline size_t
mdns_discovery_recv(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_callback_fn callback,
                    void* user_data);
...
static inline int
mdns_query_send(mdns_sock_t sock, mdns_record_type_t type, const char* name, size_t length, void* buffer,
...
static inline int
mdns_multiquery_send(mdns_sock_t sock, const mdns_query_t* query, size_t count, void* buffer,
                     size_t capacity, uint16_t query_id);
...
//! function returns non-zero. Returns the number of responses parsed.
static inline size_t
mdns_query_recv(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_callback_fn callback,
...
static inline int
mdns_query_answer_unicast(mdns_sock_t sock, const void* address, size_t address_size, void* buffer,
...
static inline int
mdns_query_answer_multicast(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_t answer,
                            const mdns_record_t* authority, size_t authority_count,
                            const mdns_record_t* additional, size_t additional_count);
...
static inline int
mdns_announce_multicast(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_t answer,
                        const mdns_record_t* authority, size_t authority_count,
                        const mdns_record_t* additional, size_t additional_count);
...
static inline int
mdns_goodbye_multicast(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_t answer,
                       const mdns_record_t* authority, size_t authority_count,
                       const mdns_record_t* additional, size_t additional_count);
...
static inline int
mdns_socket_open_ipv4(const struct sockaddr_in* saddr) {
	mdns_sock_t sock = (int)socket(AF_INET, SOCK_DGRAM, IPPROTO_UDP);
	if (sock < 0)
		return -1;
...
static inline int
mdns_socket_open_ipv6(const struct sockaddr_in6* saddr) {
	mdns_sock_t sock = (int)socket(AF_INET6, SOCK_DGRAM, IPPROTO_UDP);
	if (sock < 0)
		return -1;
...
static inline size_t
mdns_records_parse(mdns_sock_t sock, const struct sockaddr* from, size_t addrlen, const void* buffer,
...
static inline int
mdns_unicast_send(mdns_sock_t sock, const void* address, size_t address_size, const void* buffer,
                  size_t size) {
...
static inline int
mdns_multicast_send(mdns_sock_t sock, const void* buffer, size_t size) {
...
static inline int
mdns_multiquery_send(mdns_sock_t sock, const mdns_query_t* query, size_t count, void* buffer, size_t capacity,
                     uint16_t query_id) {
...
static inline int
mdns_answer_multicast_rclass_ttl(mdns_sock_t sock, void* buffer, size_t capacity, mdns_record_t answer,
                                 const mdns_record_t* authority, size_t authority_count,
                                 const mdns_record_t* additional, size_t additional_count,
